<div class="support-link-button">
  <div class="row g-0 pt-3">
    <div class="col-4 board-index-icon">
      <a href="{{ request()->fullUrlWithQuery(['sort' => 'popular'])}}" class="board-index-icon-link">
    ...
    <div class="col-4 board-index-icon">
      <a href="{{ request()->fullUrlWithQuery(['sort' => 'new'])}}" class="board-index-icon-link">
  ...
  <div class="row g-0">
    ...
    <div class="col-4 board-index-icon py-1">
      <a href="{{ route('mypage') }}" class="board-index-icon-link">
