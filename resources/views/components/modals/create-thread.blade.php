      ...
      <form action='{{ route('threads.store', $board ) }}' method="POST" x-data="{ submitting: false }" @submit="submitting = true">
        ...
        <div class="modal-body">
          ...
          <div class="form-group mt-4">
            ...
            <textarea class="form-control @error('content') is-invalid  @enderror hokkai-board-login-input pb-5" name="content" required autocomplete="content" placeholder="例：後期で単位やばいので、出席がなくて楽な講義知りたいです。">{{ old('content') }}</textarea>
