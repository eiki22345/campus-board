<footer class="footer-section bg-light border-top py-4 mt-5">
  <div class="container text-center">
    <div class="mb-2">
      <a href="{{ route('dashboard') }}" class="mx-2 text-secondary small prevent-double-click">トップ</a>
    ...
    <div class="text-muted small">
      ...
      <span class="d-block">本サイト内のコンテンツの無断転載・複製を禁じます。</span>
    </div>
  </div>
</footer>